...
<body>
<form class="form-horizontal" method="post" action="/calc" id='form1'>
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="singlebutton" name="singlebutton" class="btn btn-primary" form='form1' type='submit'>Calculate</button>
  </div>
</div>
...
def my_form_post():
	num = int(request.form['textinput'])
	return str(num*5)
